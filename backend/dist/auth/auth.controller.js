...
const validateAccount_dto_1 = require("./dto/validateAccount.dto");
const auth_guard_1 = require("./security/auth.guard");
let AuthController = class AuthController {
    constructor(authService) {
        this.authService = authService;
    }
    registerAccount(req, createUserDto) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [validateAccount_dto_1.ValidateAccountDto, Object]),
    __metadata("design:returntype", Promise)
